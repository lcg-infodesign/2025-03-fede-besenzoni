...
function setup() {
  ...
  //let allEle = vulcani.getColumn("Elevation (m)").map(Number);<-non so perchè ma non va 
...
function draw() {
 ...
 function drawVulcani() {
  ...
  for (let rowNumber = 0; rowNumber < vulcani.getRowCount(); rowNumber++) {
    ...
    //let ele = vulcani.getNum(rowNumber, "Elevation (m)");
